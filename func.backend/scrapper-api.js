...
async function hentaihome(nome) {
  return new Promise((resolve, reject) => {
    axios.get(`https://www.hentaihome.net/?s=${nome}`).then( ({data}) => {
      ...
      resolve({status: 200, autor: '@PedrozzMods', resultado: postagem})
    })
    .catch(e => {
...
async function lojadomecanico(nome) {
  return new Promise((resolve, reject) => {
    axios.get(`https://busca.lojadomecanico.com.br/busca?q=${nome}`).then( ({data}) => {
      ...
      resolve({status: 200, autor: '@PedrozzMods', resultado: dados})
    })
    .catch(e => {
      reject({status: 500, msg: `Erro no módulo`})
    });
...
async function randomGrupos(categoria) {
  return new Promise( (resolve, reject) => {
    ...
    .then( async ({data}) => {
      ...
      resolve({status: 200, criador: '@PedrozzMods', resultado: dados2})
    })
    .catch(e => {
      reject(e)
    })
...
async function topFlix(query) {
  return new Promise((resolve, reject) => {
    ...
    .then( ({data}) => {
      ...
      resolve({status: 200, criador: '@PedrozzMods', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
...
async function ultimasNoticias() {
 return new Promise((resolve, reject) => {
   ...
   resolve({status: 200, autor: '@PedrozzMods', resultado: dados2})
  })
   .catch(e => {
     reject(e)
   })
...
async function xvideosSearch(q) {
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      resolve({status: res.status, criador: '@PedrozzMods', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
...
async function iFunny() {
  return new Promise((resolve, reject) => {
    ...
    .then(res => {
      ...
      resolve({status: res.status, autor: '@PedrozzMods', imagens: dados, videos: dados2})
    })
    .catch(e => {
      reject(e)
    });
...
async function amazonSearch(query) {
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      resolve({status: res.status, autor: '@PedrozzMods', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
